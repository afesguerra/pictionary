...
public class Ejecutable {
	...
	// servidor
	private static DatagramPacket p; // Paquete donde se recibe la información
	// del servidor
	private static DatagramSocket sck; // Socket por donde se envia y recibe
	// información
	private static String nombre; // Nombre del cliente
	private static InetAddress ip; // Dirección IP del servidor
	 ...
	 * usuario para que éste esté listo para jugar
	 * 
	 * @param args
	 *            Nadie sabe XD
	 */
							...
							if (m[0].equals("error")) {
								...
								if (m[0].equals(nombre)) {
									...
									JOptionPane.showMessageDialog(window,
											"Tú eres el dibujante, la palabra a dibujar es: "
													+ m[1],
